...
/**
 * \file    test/phpunit/ModuleGPFunctionalTest.php
 * \ingroup modulegp
 ...
 *
 * @package Testmodulegp
 */
class ModuleGPFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/modulegp/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('modulegp/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/modulegp/admin/about.php');
		$this->authenticate();
		return $this->assertContains('modulegp/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('modulegpwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modModuleGP_ModuleGPTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modModuleGP_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
