...
/**
 * \file    test/phpunit/GregMModuleFunctionalTest.php
 * \ingroup gregmmodule
...
/**
 * Class GregMModuleFunctionalTest
 *
 ...
 *
 * @package Testgregmmodule
 */
class GregMModuleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGregMModule')->click();
		} else {
			// Disable the module
			$this->byHref('modGregMModule')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/gregmmodule/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gregmmodule/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gregmmodule/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gregmmodule/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gregmmodulewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGregMModule_GregMModuleTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGregMModule_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
