...
class Reservation extends CommonObject
{
	 ...
	 */
	public $table_element = 'modulegp_reservation';
	 ...
	 */
	public $picto = 'reservation@modulegp';
	 ...
	 */
	public $fields=array(
		'rowid' => array('type'=>'integer', 'label'=>'TechnicalID', 'enabled'=>'1', 'position'=>2, 'notnull'=>1, 'visible'=>0, 'noteditable'=>'1', 'index'=>1, 'css'=>'left', 'comment'=>"Id"),
		'ref' => array('type'=>'varchar(128)', 'label'=>'Ref', 'enabled'=>'1', 'position'=>10, 'notnull'=>1, 'visible'=>4, 'noteditable'=>'1', 'default'=>'(PROV)', 'index'=>1, 'searchall'=>1, 'showoncombobox'=>'1', 'comment'=>"Reference of object"),
		'label' => array('type'=>'varchar(255)', 'label'=>'Nom', 'enabled'=>'1', 'position'=>30, 'notnull'=>0, 'visible'=>1, 'searchall'=>1, 'css'=>'minwidth300', 'help'=>"Help text", 'showoncombobox'=>'1',),
		'amount' => array('type'=>'price', 'label'=>'Amount', 'enabled'=>'1', 'position'=>40, 'notnull'=>0, 'visible'=>1, 'default'=>60, 'isameasure'=>'1', 'help'=>"Help text for amount",),
        ...
        'date_reservation' => array('type'=>'datetime', 'label'=>'Date Réservation', 'enabled'=>'1', 'position'=>1, 'notnull'=>1, 'visible'=>1,),
	...
	//  */
	// public $table_element_line = 'modulegp_reservationline';
	...
	//  */
	// protected $childtablesoncascade = array('modulegp_reservationdet');
	...
	public function __construct(DoliDB $db)
	{
		...
		/*if ($user->rights->modulegp->reservation->read) {
	...
	public function validate($user, $notrigger = 0)
	{
		...
		/*if (! ((empty($conf->global->MAIN_USE_ADVANCED_PERMS) && ! empty($user->rights->modulegp->reservation->write))
		 || (! empty($conf->global->MAIN_USE_ADVANCED_PERMS) && ! empty($user->rights->modulegp->reservation->reservation_advance->validate))))
		 {
		...
		if (!$error)
		{
			...
			if (preg_match('/^[\(]?PROV/i', $this->ref))
			{
				...
				$dirsource = $conf->modulegp->dir_output.'/reservation/'.$oldref;
				$dirdest = $conf->modulegp->dir_output.'/reservation/'.$newref;
				if (!$error && file_exists($dirsource))
				{
					...
					if (@rename($dirsource, $dirdest))
					{
						...
						$listoffiles = dol_dir_list($conf->modulegp->dir_output.'/reservation/'.$newref, 'files', 1, '^'.preg_quote($oldref, '/'));
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/modulegp/reservation_card.php', 1).'?id='.$this->id;
	...
	public function getNextNumRef()
	{
		...
		if (empty($conf->global->MODULEGP_RESERVATION_ADDON)) {
			$conf->global->MODULEGP_RESERVATION_ADDON = 'mod_reservation_standard';
		}
		...
		if (!empty($conf->global->MODULEGP_RESERVATION_ADDON))
		{
			...
			$file = $conf->global->MODULEGP_RESERVATION_ADDON.".php";
			$classname = $conf->global->MODULEGP_RESERVATION_ADDON;
